    ...
    <div style={{gridArea: "info", textAlign: "start"}}>
        ...
        <p>
            <ul>
                ...
                <li>
                    <em>Hides</em> any notification comming from interactions from users in
                    silenced domains. <br/>You'll will not be notified if someone from a
                    silenced domain mentions you, or if they reply, favorite or boost your
                    posts. More on that bellow.
                </li>
            </ul>
        </p>
